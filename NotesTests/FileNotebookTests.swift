...
public class FileNotebookTests: XCTestCase {
    ...
    func testFileNotebook_whenSaveToFileAndLoadFromFile_correctRestoreNotes() {
        ...
        let note2 = Note(title: "New Title", content: "My new text", color: .red, importance: .important, selfDestructDate: Date())
        sut.add(note2)
        ...
        let note3 = Note(title: "New Title3", content: "My new text3", color: .green, importance: .unimportant, selfDestructDate: Date())
        sut.add(note3)
